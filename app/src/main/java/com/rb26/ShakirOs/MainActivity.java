...
public class MainActivity extends AppCompatActivity {
        ...
        class LoadRestaurant extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest
                        ("https://s-z-o.000webhostapp.com/shakiros/load_shop.php",hashMap);
                return s;
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try{
                    ...
                    Log.e("SHAKIR",jsonObject.toString());
    ...
    private void loadHistoryOrderData() {
        class LoadOrderData extends AsyncTask<Void,String,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("https://s-z-o.000webhostapp.com/shakiros/load_order_history.php",hashMap);
                return s;
            }
    ...
    private void loadCartWindow() {
        ...
        Log.e("SHAKIR","SIZE:"+cartlist.size());
    ...
    private void deleteCartFood(final int position) {
        class DeleteCartFood extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = requestHandler.sendPostRequest("https://s-z-o.000webhostapp.com/shakiros/delete_cart.php",hashMap);
                return s;
            }
            @Override
            protected void onPostExecute(String s) {
    ...
    private void loadCartData() {
        class LoadCartData extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                hashMap.put("userid",phone);
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("https://s-z-o.000webhostapp.com/shakiros/load_cart.php",hashMap);
                return s;
            }
